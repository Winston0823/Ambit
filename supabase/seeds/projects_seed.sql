...
-- CloudFront CDN). Founder photo_url is null so the card never shows a face as
...
-- ── Founder profiles (role=owner, is_seed=true, no photo) ─────
insert into profiles (
  id, edu_email, demographic, name,
  vibe_blurb, skills, role,
  campus_id, photo_url, response_rate,
  last_meaningful_action_at, updated_at, is_seed
) values
  ('d4000000-0000-0000-0000-000000000001','nadia.okonkwo@usc.edu','student','Nadia Okonkwo',
   'Building warmer ways for students to find their people on campus.',
   array['product strategy','ui/ux'],'owner','usc', null, 0.94, now(), now(), true),
  ('d4000000-0000-0000-0000-000000000002','ravi.menon@ucla.edu','student','Ravi Menon',
   'AI + education. Trying to make studying feel less like a grind.',
   array['python','machine learning'],'owner','ucla', null, 0.88, now(), now(), true),
  ('d4000000-0000-0000-0000-000000000003','grace.walker@usc.edu','student','Grace Walker',
   'Designing tools that make good habits feel effortless.',
   array['figma','ui/ux'],'owner','usc', null, 0.91, now(), now(), true),
  ('d4000000-0000-0000-0000-000000000004','leo.castellano@caltech.edu','student','Leo Castellano',
   'Civic tech for campus — small tools, real impact.',
   array['web','typescript'],'owner','caltech', null, 0.83, now(), now(), true)
...
insert into projects (
  ...
  required_skills, roles_sought, campus_id,
  ...
  ('e5000000-0000-0000-0000-000000000001','d4000000-0000-0000-0000-000000000001',
   ...
   array['react native','typescript','ui/ux'], array['Mobile','Frontend'],'usc',
  ...
  ('e5000000-0000-0000-0000-000000000002','d4000000-0000-0000-0000-000000000002',
   ...
   array['python','machine learning','web'], array['ML / AI','Full Stack'],'ucla',
  ...
  ('e5000000-0000-0000-0000-000000000003','d4000000-0000-0000-0000-000000000001',
   ...
   array['typescript','web','python'], array['Full Stack','Backend'],'usc',
  ...
  ('e5000000-0000-0000-0000-000000000004','d4000000-0000-0000-0000-000000000003',
   ...
   array['react native','ui/ux','figma'], array['Mobile','Product Design'],'usc',
  ...
  ('e5000000-0000-0000-0000-000000000005','d4000000-0000-0000-0000-000000000002',
   ...
   array['python','web','machine learning'], array['ML / AI','Frontend'],'ucla',
  ...
  ('e5000000-0000-0000-0000-000000000006','d4000000-0000-0000-0000-000000000004',
   ...
   array['web','typescript','ui/ux'], array['Frontend','Full Stack'],'caltech',
