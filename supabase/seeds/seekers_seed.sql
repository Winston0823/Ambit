...
insert into profiles (
  ...
  avatar_id, open_to_nearby, photo_url,
  last_meaningful_action_at, updated_at, is_seed
) values
  ('c3000000-0000-0000-0000-000000000001','sofia.restrepo@usc.edu','Sofia Restrepo',
   'Frontend dev obsessed with the last 10% of polish. Shipped two campus apps students actually use.',
   array['typescript','web','react native','ui/ux'],'seeker','monster-02', true,
  ...
  ('c3000000-0000-0000-0000-000000000002','marcus.lee@usc.edu','Marcus Lee',
   'Product designer who codes. I prototype in Figma and ship the real thing in React.',
   array['figma','ui/ux','prototyping','web'],'seeker','monster-05', false,
  ...
  ('c3000000-0000-0000-0000-000000000003','priya.nair@ucla.edu','Priya Nair',
   'ML student into recsys and clean dataviz. I turn messy data into something you can actually decide with.',
   array['python','machine learning','data science'],'seeker','monster-07', true,
  ...
  ('c3000000-0000-0000-0000-000000000004','diego.alvarez@usc.edu','Diego Alvarez',
   'Backend + infra. I like building systems that don''t fall over at 2am.',
   array['python','go','devops','web'],'seeker','monster-09', false,
  ...
  ('c3000000-0000-0000-0000-000000000005','hannah.cohen@ucla.edu','Hannah Cohen',
   'Product + UX research. I talk to users until the real problem is obvious, then we build that.',
   array['user research','product strategy','ui/ux'],'seeker','monster-12', true,
  ...
  ('c3000000-0000-0000-0000-000000000006','kwame.mensah@usc.edu','Kwame Mensah',
   'Mobile engineer. Built a campus transit app used by 3k students last semester.',
   array['swift','ios','react native','typescript'],'seeker','monster-04', null,
  ...
  ('c3000000-0000-0000-0000-000000000007','emily.zhang@caltech.edu','Emily Zhang',
   'Low-level + ML. Currently obsessed with making model inference embarrassingly fast.',
   array['python','rust','machine learning'],'seeker','monster-06', true,
  ...
  ('c3000000-0000-0000-0000-000000000008','jordan.brooks@ucla.edu','Jordan Brooks',
   'Growth person. I find the one channel that works and pour fuel on it.',
   array['growth strategy','marketing','web'],'seeker','monster-08', false,
  ...
  ('c3000000-0000-0000-0000-000000000009','aisha.rahman@usc.edu','Aisha Rahman',
   'Motion + interaction designer. The details are the design — I sweat the easing curves.',
   array['figma','motion','prototyping','ui/ux'],'seeker','monster-11', true,
  ...
  ('c3000000-0000-0000-0000-000000000010','tyler.nguyen@usc.edu','Tyler Nguyen',
   'Full-stack generalist. I like turning a vague idea into a working v1 by the weekend.',
   array['typescript','web','python','devops'],'seeker','monster-03', null,
