...
/// S-007 Vibe Blurb Composer. 50–280 char.
...
const styles = StyleSheet.create({
  root: { flex: 1, paddingHorizontal: 25, backgroundColor: Brand.canvas },
  ...
  textArea: {
    height: 114, borderRadius: Radii.lg, padding: 14, marginTop: 16,
